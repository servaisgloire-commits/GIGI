...
export async function updateRidePriceAction(fd:FormData){await updateRidePrice(String(fd.get('id')),Number(fd.get('price')));revalidatePath('/courses')}
